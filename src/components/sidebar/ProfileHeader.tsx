    ...
    <>
      {isSidebarOpen && (
        <>
          {/* Background Image */}
          <motion.div
            className="absolute inset-x-0 top-0 h-24 bg-cover bg-center z-0 rounded-lg overflow-hidden" // Ganti h-1/2 ke h-20
            style={{
          ...
          {/* Overlay */}
          <motion.div
            className="absolute inset-x-0 top-0 h-24 bg-black/50 z-0 rounded-lg"
            style={{ margin: "12px" }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
